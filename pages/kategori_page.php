...
$berita_kategori = query("SELECT * FROM berita,kategori where berita.id_kategori=kategori.id_kategori and berita.id_kategori=$id");
$berita_kategori_terkini = array_reverse($berita_kategori);
$carousel1 = $berita_kategori_terkini[0];
$carousel2 = $berita_kategori_terkini[1];
$carousel3 = $berita_kategori_terkini[2];
?>
...
<head>
    ...
    <title>Portal Berita | <?php echo $berita_kategori_terkini[0]["kategori"]; ?></title>
...
<div class="container">
    <div class="pt-3 pb-2">
        <h2><?php echo $berita_kategori_terkini[0]["kategori"]; ?></h2>
        <hr>
    </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <a href="berita_page.php?id=<?php echo $carousel1["id_berita"]; ?>" class="h4 text-shadow text-decoration-none"><?php echo $carousel1["judul"]; ?></a>
                </div>
            </div>
            <div class="carousel-item">
                <img src="../img/<?php echo $carousel2["gambar"]; ?>" onerror="this.src='../img/logo.png'" class="d-block w-100" style="max-height: 500px;" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <a href="berita_page.php?id=<?php echo $carousel2["id_berita"]; ?>" class="h4 text-shadow text-decoration-none"><?php echo $carousel2["judul"]; ?></a>
                </div>
            </div>
            <div class="carousel-item">
                <img src="../img/<?php echo $carousel3["gambar"]; ?>" onerror="this.src='../img/logo.png'" class="d-block w-100" style="max-height: 500px;" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <a href="berita_page.php?id=<?php echo $carousel3["id_berita"]; ?>" class="h4 text-shadow text-decoration-none"><?php echo $carousel3["judul"]; ?></a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <?php foreach ($berita_kategori_terkini as $row) : ?>
